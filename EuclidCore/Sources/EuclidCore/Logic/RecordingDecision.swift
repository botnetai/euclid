...
public struct RecordingDecisionEngine {
    ...
    /// See `EuclidCoreConstants.modifierOnlyMinimumDuration` for rationale.
    public static let modifierOnlyMinimumDuration: TimeInterval = EuclidCoreConstants.modifierOnlyMinimumDuration
