...
private let hotKeyLogger = EuclidLog.hotKey
...
public struct HotKeyProcessor {
    ...
    public static let doubleTapThreshold: TimeInterval = EuclidCoreConstants.doubleTapWindow
    ...
    public static let pressAndHoldCancelThreshold: TimeInterval = EuclidCoreConstants.pressAndHoldCancelWindow
