...
/// Central repository for timing thresholds and magic numbers used throughout EuclidCore.
///
...
public enum EuclidCoreConstants {
    ...
    ///
    /// **Used in:**
    /// - `EuclidSettings`: Default value for user preference
    ...
    ///
    /// **Used in:**
    /// - `EuclidSettings`: Default sound effects volume
