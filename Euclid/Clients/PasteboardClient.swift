...
private let pasteboardLogger = EuclidLog.pasteboard
...
struct PasteboardClientLive {
    ...
    func paste(text: String) async {
        if euclidSettings.useClipboardPaste {
    ...
    func pasteWithClipboard(_ text: String) async {
        ...
        if !euclidSettings.copyToClipboard && pasteSucceeded {
        ...
        if !pasteSucceeded && !euclidSettings.copyToClipboard {
