		...
		Section {
			Label {
				Toggle("Open on Login",
				       isOn: Binding(
				       	get: { store.euclidSettings.openOnLogin },
			...
			Label {
				Toggle(
					"Show Dock Icon",
					isOn: Binding(
						get: { store.euclidSettings.showDockIcon },
			...
			Label {
				Toggle(
					...
					isOn: Binding(
						get: { store.euclidSettings.useClipboardPaste },
			...
			Label {
				Toggle(
					"Copy to clipboard",
					isOn: Binding(
						get: { store.euclidSettings.copyToClipboard },
			...
			Label {
				Toggle(
					...
					isOn: Binding(
						get: { store.euclidSettings.preventSystemSleep },
			...
			Label {
				Toggle(
					"Super Fast Mode",
					isOn: Binding(
						get: { store.euclidSettings.superFastModeEnabled },
			...
			Label {
				...
				Spacer()
					Picker("", selection: Binding(
						get: { store.euclidSettings.recordingAudioBehavior },
